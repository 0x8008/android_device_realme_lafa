...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/display/displayconfig.xml:$(TARGET_COPY_OUT_VENDOR)/etc/displayconfig/display_id_4630947180293509523.xml
...
# Regional properties
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/recovery/root/vendor/odm/etc/24624/build.default.prop:$(TARGET_COPY_OUT_ODM)/etc/24624/build.default.prop \
    $(LOCAL_PATH)/recovery/root/vendor/odm/etc/24624/flags.prop:$(TARGET_COPY_OUT_ODM)/etc/24624/flags.prop
...
$(call soong_config_set,qti_vibrator,effect_lib,libqtivibratoreffect.oplus.lafa)
