...
public class ViewRootImpl {
    ...
    public void registerRtFrameCallback(com.oplus.wrapper.graphics.HardwareRenderer.FrameDrawingCallback callback) {
        if (callback != null) mViewRootImpl.registerRtFrameCallback(callback::onFrameDraw);
    }
}
