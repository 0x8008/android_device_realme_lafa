...
public class OplusActivityManager extends OplusBaseActivityManager implements IOplusActivityManager, IOplusActivityTaskManager {
    ...
    public boolean putConfigInfo(String configName, Bundle bundle, int flag, int userId) throws RemoteException {
        ...
        try {
            ...
            if (!this.mRemote.transact(10062, data, reply, 0)) {
    ...
    public Bundle getConfigInfo(String configName, int flag, int userId) throws RemoteException {
        ...
        try {
            ...
            data.writeInt(flag);
            data.writeInt(userId);
            if (!this.mRemote.transact(10063, data, reply, 0)) {
                throw new android.os.RemoteException("OEM transaction is unavailable");
            }
            reply.readException();
    ...
    public boolean requestDeviceFolded(int displayId, boolean folded) { return false; }
    public void startActivity(android.content.Intent intent) {
        android.content.Context context = ActivityThread.currentApplication();
        if (context != null) context.startActivity(new android.content.Intent(intent)
